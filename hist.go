...
type areaHandler1 struct{}

func (areaHandler1) Draw(a *ui.Area, p *ui.AreaDrawParams) {
...
func (areaHandler1) MouseEvent(a *ui.Area, me *ui.AreaMouseEvent) {
...
func (areaHandler1) MouseCrossed(a *ui.Area, left bool) {
	// do nothing
}

func (areaHandler1) DragBroken(a *ui.Area) {
	// do nothing
}

func (areaHandler1) KeyEvent(a *ui.Area, ke *ui.AreaKeyEvent) (handled bool) {
	// reject all keys
	return false
}
...
func hist() {
	...
	histogram = ui.NewArea(areaHandler1{})
